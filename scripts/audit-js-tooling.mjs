...
const ALLOWED = {
  "GHSA-qxc2-j82w-r537": {
    ...
    reason:
      ...
      "postman-collection/lib/superstring, which makes every tests/contract " +
      "case uncollectable. Not reachable as we run Prism: tests/contract/conftest.py " +
      ...
      "nothing. Prism is a devDependency and is never part of the published wheel.",
  },
};
