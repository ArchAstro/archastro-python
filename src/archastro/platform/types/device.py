...
class DeviceAuthorizationDetailsResponse(BaseModel):
    """
    User-visible details for a pending OAuth 2.0 device authorization.
    """

    client_name: str = Field(..., description="Name of the client requesting authorization.")
    expires_at: datetime = Field(
        ..., description="Expiration time for the pending device authorization."
    )
    scopes: list[str] = Field(..., description="Scopes the client is requesting.")
