...
class TeamDeleteImpactResponse(BaseModel):
    """
    The stored custom-object rows that a Team deletion will physically remove.
    """

    custom_object_count: int = Field(
        ..., description="All custom-object rows owned by the Team, including soft-deleted rows."
    )
    custom_objects_physically_deleted: bool = Field(
        ...,
        description="Whether Team deletion physically deletes these rows; no restore is provided.",
    )
