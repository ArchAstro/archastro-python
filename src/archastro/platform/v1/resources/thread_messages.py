...
class AsyncThreadMessageResource:
    ...
    async def replace(self, message: str, input: ThreadMessageReplaceInput) -> Message:
        ...
        Args:
            ...
            input.metadata: Replacement key-value metadata. Keys beginning with `sys:` are reserved and stripped.
            input.type: Replacement client-defined classification. Free-form string up to 64 characters; platform-reserved values such as `system` are rejected.
