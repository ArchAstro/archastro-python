...
class ConfigValidateInput(TypedDict, total=False):
    ...
    system: bool | None
    "Set to true to validate as a system-owned config. Mutually exclusive with `team`, `user`, and `agent`."
    team: str | None
...
class AsyncConfigResource:
    ...
    async def validate(self, input: ConfigValidateInput) -> ValidationResult:
        ...
        Args:
            ...
            input.system: Set to true to validate as a system-owned config. Mutually exclusive with `team`, `user`, and `agent`.
