...
class ThreadMessagesResponseDataMessagesItemContextItem(BaseModel):
...
class ThreadMessagesResponseDataMessagesItem(BaseModel):
    ...
    context: list[ThreadMessagesResponseDataMessagesItemContextItem] | None = Field(
        default=None,
...
class ThreadSearchResponseDataItem(BaseModel):
    ...
    evidence: dict[str, Any] = Field(
        ...,
        description="Bounded, allowlisted structured-post evidence such as source, lifecycle type, references, repository context, and addressee. Empty for ordinary messages.",
    )
    id: str = Field(..., description="Message ID (`msg_...`).")
...
class AsyncThreadResource:
    ...
    async def artifacts(
        self, thread: str, *, group_key: str | None = None, group_key_prefix: str | None = None
