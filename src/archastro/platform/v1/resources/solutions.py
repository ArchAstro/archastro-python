...
from ...types.common import (
    ProductKnowledgeReconcileResponse,
...
class AsyncSolutionResource:
    ...
    async def reconcile_product_knowledge(self, solution: str) -> ProductKnowledgeReconcileResponse:
        """
        ...
        Args:
            solution: Installed Customer Management Solution config (`cfg_...`) to reconcile.

        Returns:
            Per-customer convergence result for this installed solution.
        """
        return await self._http.request(
            f"/api/v1/solutions/{solution}/reconcile_product_knowledge",
            method="POST",
            response_type=ProductKnowledgeReconcileResponse,
        )
...
class SolutionResource:
    ...
    def reconcile_product_knowledge(self, solution: str) -> ProductKnowledgeReconcileResponse:
        """
        Reconcile Customer Management product knowledge
        Recomputes every stamped customer's knowledge-search source allowlist
        from the template-resolved customer refs plus the install's current marked
