...
class TeamThreadListResponseDataItem(BaseModel):
    ...
    kind: str | None = Field(
        default=None,
        description='Thread subtype: `"standard"` for ordinary threads, `"slack_mirror"` for the membership-strict mirror of a Slack channel, `"slashwork_mirror"` for the membership-strict mirror of a Slashwork group. Read-only derived server-side at creation, never accepted from params.',
    )
