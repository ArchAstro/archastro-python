...
class AsyncTaskResource:
    ...
    async def metrics(self, team: str, *, days: int | None = None) -> TaskMetricsResponse:
        """
        ...
        Args:
            team: Team ID (`tem_...`) whose task metrics should be returned.
        ...
        return await self._http.request(
            ...
            query=query,
            response_type=TaskMetricsResponse,
        )
...
class AsyncTeamResource:
    def __init__(self, http: HttpClient):
        ...
        self.tasks = AsyncTaskResource(http)
...
class TaskResource:
    ...
    def metrics(self, team: str, *, days: int | None = None) -> TaskMetricsResponse:
        """
        Get task activity metrics for a team
        Returns task activity metrics scoped to one team (the Network in ArchAgents).
        `open` counts currently open or in-progress team tasks, `created` counts
