...
from ...types.common import (
    ...
    SlackDeliveryOutcomeListResponse,
)
...
class SlackChannelBindingAssignInput(TypedDict):
...
class AsyncSlackChannelBindingResource:
    ...
    async def assign(self, input: SlackChannelBindingAssignInput) -> SlackChannelBinding:
        """
        Assign a Slack channel's resident agent
        ...
        Args:
            input: Request body.
            input.agent_user_id: Agent user ID to assign as the channel's sole resident.
            input.channel_id: Slack channel ID whose resident is being assigned (e.g. `C01234ABCDE`). A bare internal binding is created when the channel has none.
            input.slack_team_id: Slack workspace team ID that the channel belongs to (e.g. `T01234ABCDE`). Identifies which Slack integration to use.
        ...
        """
        return await self._http.request(
            "/api/v1/slack_channel_bindings/assign",
            method="POST",
            body=input,
            response_type=SlackChannelBinding,
        )
    ...
    async def delivery_outcomes(
        self,
        channel: str,
        *,
        since: str | None = None,
        outcome: Literal["delivered", "floored", "judge_refused", "failed"] | None = None,
        limit: int | None = None,
        ...
        return await self._http.request(
            f"/api/v1/slack_channel_bindings/{channel}/delivery_outcomes",
            query=query,
            response_type=SlackDeliveryOutcomeListResponse,
        )
...
class SlackChannelBindingResource:
    ...
    def assign(self, input: SlackChannelBindingAssignInput) -> SlackChannelBinding:
        """
        Assign a Slack channel's resident agent
        Makes the given agent the channel's sole resident (one resident per
        channel: any previously attached agent is detached in the same
