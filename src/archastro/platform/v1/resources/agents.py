...
from ...types.workflows import WorkflowWorkItemClaim, WorkflowWorkItemList
...
class AgentSearchInput(TypedDict, total=False):
    ...
    'Exact source-type slugs filtering both chunks and documents, e.g. `["knowledge/documents"]` for authored documents or `["thread/messages"]` for conversation memory. Omit or pass an empty array to include all source types.'
...
class AsyncAgentResource:
    ...
    async def search(self, agent: str, input: AgentSearchInput) -> AgentSearchResponse:
        ...
        Args:
            ...
            input.source_types: Exact source-type slugs filtering both chunks and documents, e.g. `["knowledge/documents"]` for authored documents or `["thread/messages"]` for conversation memory. Omit or pass an empty array to include all source types.
