...
from ...types.device import (
    DeviceAuthorizationDetailsResponse,
...
class AsyncDeviceResource:
    ...
    async def authorization(self, code: str) -> DeviceAuthorizationDetailsResponse:
        """
        ...
        return await self._http.request(
            ...
            query=query,
            response_type=DeviceAuthorizationDetailsResponse,
        )
...
class AsyncOauthResource:
    ...
    async def token(self, input: OauthTokenInput) -> OAuthTokenResponse:
        ...
        Args:
            input: Request body.
            input.client: OAuth client ID identifying the application requesting tokens. Required for `"authorization_code"`, device-code, and resource-bound refresh grants.
...
class DeviceResource:
    ...
    def authorization(self, code: str) -> DeviceAuthorizationDetailsResponse:
        """
        Inspect a pending device authorization
        Returns the client name, requested scopes, and expiration for a pending
        device authorization owned by the calling app. The caller must be an
